...
\end{doublespace}
\mybox{\begin{itemize}
\item Definition: $h(z)$ is analytic if and only if (iff) $H(z)$ exist and is indepent of $(a,b)\in\mathbb{R}^2 \backslash (0,0)$
...
alternativ: $ \frac{\partial}{\partial \vec{z}}(\vec{z}^H\vec{p}+\vec{p}^H\vec{z}) = \vec{p}^* $
